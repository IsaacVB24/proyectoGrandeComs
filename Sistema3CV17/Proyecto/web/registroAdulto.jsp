...
<html>
    ...
    <body background="Imagenes/Rojo.jpg">
        ...
        <div>
            <form autocomplete="off" novalidate="novalidate" action="SRegistroPersna" method="post">
        ...
        <p align="center"><input type="button" value="REGRESAR" OnClick="location.href = 'indexPersona.jsp'"></p></center>
</body>
</html>
